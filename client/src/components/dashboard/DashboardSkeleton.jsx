      ...
      <main className="flex-1 w-full mx-auto px-6 mt-10 flex flex-col gap-10">
        ...
        <section className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-5">
          <div className="flex flex-col gap-3">
            ...
            <div className="h-8 bg-[#D4D4D8] w-40 rounded" />
            <div className="h-4 bg-[#F3F4F6] w-48 rounded" />
          </div>
          <div className="h-10 bg-[#D4D4D8] w-32 rounded-md" />
        </section>
          ...
          {[1, 2, 3].map((i) => (
            <div key={i} className="bg-white p-5 border border-[#D4D4D8] rounded-xl flex flex-col gap-4">
              <div className="flex justify-between items-start">
                ...
                <div className="w-10 h-10 bg-[#F3F4F6] border border-[#D4D4D8] rounded-lg flex items-center justify-center">
                  <div className="w-5 h-5 bg-[#D4D4D8] rounded" />
                </div>
              </div>
              <div className="h-9 bg-[#D4D4D8] w-14 rounded mt-1" />
        ...
        <section className="flex flex-col gap-4">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
            ...
            <div className="flex gap-2 w-full sm:w-auto">
              <div className="h-10 bg-[#D4D4D8] w-full sm:w-56 rounded-md" />
              <div className="h-10 bg-[#D4D4D8] w-20 rounded-md" />
            </div>
          </div>
            ...
            <div className="divide-y divide-[#E5E5EA]">
              {[1, 2, 3, 4, 5].map((i) => (
                <div key={i} className="px-6 py-4 flex items-center gap-8">
                  ...
                  <div className="h-4 bg-[#D4D4D8] w-8 rounded font-mono" />
