                  ...
                  {profileMenuOpen && (
                    ...
                    >
                      ...
                      <div className="p-1.5 border-t border-gray-100">
                        ...
                        >
                          {mutation.isPending ? (
                            <LuLoaderCircle className="w-4 h-4 text-gray-400 shrink-0 animate-spin" />
                          ) : (
                            <LuLogOut className="w-4 h-4 text-gray-400 shrink-0" />
                          )}
              ...
              {isAuthenticated ? (
                <>
                  ...
                  <div className="p-1.5">
                    ...
                    >
                      <LuHouse className="w-4 h-4 text-gray-400 shrink-0" />
                      Dashboard
                    </Link>
                    <Link
                      to="/analytics"
                    ...
                    >
                      <LuChartNoAxesColumn className="w-4 h-4 text-gray-400 shrink-0" />
                      Analytics
                    </Link>
                    <Link
                      to="/settings"
