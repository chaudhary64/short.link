...
const Settings = () => {
  ...
  const { name, email, created_at, gender } = useUserInfo();
  ...
  const updateProfileMutation = useMutation({
    ...
    onSuccess: (res) => {
      ...
      setUserInfo({ name: serverName, email, created_at, gender });
        ...
        <Card className="flex flex-col gap-6">
          ...
          {isChangingPassword ? (
            <form onSubmit={handlePasswordChange} className="flex flex-col gap-4">
              ...
              <div className="flex gap-3">
                <Button type="submit" variant="primary" size="medium" disabled={changePasswordMutation.isPending}>
                  {changePasswordMutation.isPending ? "Changing..." : "Change Password"}
                </Button>
                <Button type="button" variant="secondary" size="medium" onClick={() => { setIsChangingPassword(false); setCurrentPassword(""); setNewPassword(""); setConfirmPassword(""); }}>
                  Cancel
                </Button>
              </div>
            </form>
            ...
            <div>
              <Button variant="secondary" size="medium" onClick={() => setIsChangingPassword(true)}>
                Change Password
              </Button>
            </div>
          )}
