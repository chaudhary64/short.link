    ...
    >
      ...
      >
        ...
        <form action={handleSubmit} className="g-form gap-4">
          <div className="g-field">
            ...
            {touched.email && errors.email && (
              <p className="g-field-err"><span className="g-sq g-sq-red" aria-hidden="true"></span>{errors.email}</p>
            )}
          </div>
          ...
          <div className="g-field">
            ...
            {touched.password && errors.password && (
              <p className="g-field-err"><span className="g-sq g-sq-red" aria-hidden="true"></span>{errors.password}</p>
            )}
          </div>
        ...
        <p className="g-auth-switch">
          ...
          <Link to="/signup" className="g-auth-link">Sign up</Link>
        </p>
      </motion.div>
    </motion.div>
  );
